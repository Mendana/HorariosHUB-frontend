# ENDPOINTS.md — API propuesta para Horarios Hub
...
// Response 200
{
  "data": [{ "email": "uo123456@uniovi.es", "role": "professor" }],
  "total": 1,
  "page": 1,
  "limit": 20
}
...
| _(nuevo)_                             | —      | `/api/subjects/auto-select/status` | Sustituye el polling sobre localStorage                        |
| _(nuevo)_                             | —      | `/api/proposals` (POST)            | Nuevo: cualquier usuario autenticado puede proponer            |
| _(nuevo)_                             | —      | `/api/proposals/mine`              | Nuevo: usuario ve sus propias propuestas                       |
